...
class TestWikiLinkPlugin:
    ...
    def test_wiki_link_basic(self):
        ...
        assert (
            '<a href="/Test_Page.html" data-wiki-link="Test_Page" class="wiki-link-invalid">Test Page</a>'
            in result
        )
    ...
    def test_wiki_link_with_display_text(self):
        ...
        assert (
            '<a href="/test_page.html" data-wiki-link="test_page" class="wiki-link-invalid">Display Text</a>'
            in result
        )
    ...
    def test_wiki_link_mixed_with_regular_markdown(self):
        ...
        assert (
            '<a href="/wiki_link.html" data-wiki-link="wiki_link" class="wiki-link-invalid">wiki link</a>'
            in result
        )
    ...
    def test_wiki_link_nested_in_other_elements(self):
        ...
        assert (
            '<strong>Bold <a href="/wiki_link.html" data-wiki-link="wiki_link" class="wiki-link-invalid">wiki link</a></strong>'
            in result
        )
        # Note: The italic text has a space after "italic" so we need to account for that
        assert (
            '<em>italic <a href="/another_link.html" data-wiki-link="another_link" class="wiki-link-invalid">another link</a></em>'
            in result
        )
    ...
    def test_wiki_link_in_list(self):
        ...
        assert (
            '<li>Item with <a href="/wiki_link.html" data-wiki-link="wiki_link" class="wiki-link-invalid">wiki link</a></li>'
            in result
        )
    ...
    def test_wiki_link_with_pipe_in_display_text(self):
        ...
        assert (
            '<a href="/target.html" data-wiki-link="target" class="wiki-link-invalid">display|with|pipes</a>'
            in result
        )
...
class TestRenderMarkdownWithWikiLinks:
    ...
    def test_render_without_username(self):
        ...
        assert (
            '<a href="/a_test.html" data-wiki-link="a_test" class="wiki-link-invalid">a test</a>'
            in result
        )
    ...
    def test_render_with_valid_link(self, db):
        ...
        result = render_markdown_with_wiki_links(
            "This is [[test_page_valid]] link.", "testuser_valid"
        )

        # Should render the link as valid
        assert (
            '<a href="/test_page_valid.html" data-wiki-link="test_page_valid" class="wiki-link-valid">test_page_valid</a>'
            in result
        )
    ...
    def test_render_with_invalid_link(self, db):
        ...
        result = render_markdown_with_wiki_links(
            "This is [[nonexistent]] link.", "testuser_invalid"
        )

        # Should render the link as invalid
        assert (
            '<a href="/nonexistent.html" data-wiki-link="nonexistent" class="wiki-link-invalid">nonexistent</a>'
            in result
        )
    ...
    def test_render_with_display_text(self, db):
        ...
        result = render_markdown_with_wiki_links(
            "This is [[test_page_display|Display Text]] link.", "testuser_display"
        )

        # Should render with display text and valid class
        assert (
            '<a href="/test_page_display.html" data-wiki-link="test_page_display" class="wiki-link-valid">Display Text</a>'
            in result
        )
    ...
    def test_render_mixed_valid_and_invalid(self, db):
        ...
        assert (
            '<a href="/test_page_1_mixed.html" data-wiki-link="test_page_1_mixed" class="wiki-link-valid">test_page_1_mixed</a>'
            in result
        )
        assert (
            '<a href="/test_page_2_mixed.html" data-wiki-link="test_page_2_mixed" class="wiki-link-invalid">test_page_2_mixed</a>'
            in result
        )
    ...
    def test_render_with_nonexistent_user(self, db):
        ...
        result = render_markdown_with_wiki_links(
            "This is [[a test]] link.", "nonexistent_user"
        )
