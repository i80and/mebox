...
class TestAdminModelActions:
    ...
    def test_admin_can_create_wikipage(self, logged_in_admin_client, user):
        ...
        response = logged_in_admin_client.post('/admin/wiki/wikipage/add/', {
    ...
    def test_admin_can_create_pagerevision(self, logged_in_admin_client, user, wiki_page):
        """Test that admin can create PageRevision"""
        initial_count = PageRevision.objects.count()
        
        response = logged_in_admin_client.post('/admin/wiki/pagerevision/add/', {
            'page': wiki_page.id,
    ...
    def test_admin_can_create_useractivity(self, logged_in_admin_client, user):
        ...
        response = logged_in_admin_client.post('/admin/wiki/useractivity/add/', {
            'user': user.id,
